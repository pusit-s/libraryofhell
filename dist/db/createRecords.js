...
exports.createBorrowTransactions = createBorrowTransactions;
exports.createBorrowRecords = createBorrowRecords;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
function createBorrowTransactions() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield prisma.borrowTransaction.createMany({ data: borrowTransactions });
        console.log("✅ Borrow transactions seeded!");
    });
}
function createBorrowRecords() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield prisma.borrowRecord.createMany({ data: borrowRecords });
